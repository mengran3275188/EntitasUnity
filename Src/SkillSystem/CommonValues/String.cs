...
{
  internal sealed class FormatValue : ISkillValue<object>
  {
    ...
    private ISkillValue<string> m_Format = new SkillValue<string>();
    private List<ISkillValue<object>> m_FormatArgs = new List<ISkillValue<object>>();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class SubstringValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<string> m_String = new SkillValue<string>();
    private ISkillValue<int> m_Start = new SkillValue<int>();
    private ISkillValue<int> m_Length = new SkillValue<int>();
    private bool m_HaveValue;
    private object m_Value;
  }
}
