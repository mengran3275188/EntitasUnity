...
{
  internal sealed class PropGetValue : ISkillValue<object>
  {
    ...
    private ISkillValue<string> m_VarName = new SkillValue<string>();
    private ISkillValue<object> m_DefaultValue = new SkillValue();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class RandomIntValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<int> m_Min = new SkillValue<int>();
    private ISkillValue<int> m_Max = new SkillValue<int>();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class RandomFloatValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class Vector2Value : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<float> m_X = new SkillValue<float>();
    private ISkillValue<float> m_Y = new SkillValue<float>();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class Vector3Value : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<float> m_X = new SkillValue<float>();
    private ISkillValue<float> m_Y = new SkillValue<float>();
    private ISkillValue<float> m_Z = new SkillValue<float>();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class Vector4Value : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<float> m_Y = new SkillValue<float>();
    private ISkillValue<float> m_Z = new SkillValue<float>();
    private ISkillValue<float> m_W = new SkillValue<float>();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class QuaternionValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class EularValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class Vector2DistanceValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<Vector2> m_Pt1 = new SkillValue<Vector2>();
    private ISkillValue<Vector2> m_Pt2 = new SkillValue<Vector2>();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class Vector3DistanceValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<Vector3> m_Pt1 = new SkillValue<Vector3>();
    private ISkillValue<Vector3> m_Pt2 = new SkillValue<Vector3>();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class Vector2To3Value : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<Vector2> m_Pt = new SkillValue<Vector2>();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class Vector3To2Value : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<Vector3> m_Pt = new SkillValue<Vector3>();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class StringListValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private ISkillValue<string> m_ListString = new SkillValue<string>();
    private bool m_HaveValue;
    private List<object> m_Value;
  }
  internal sealed class IntListValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class FloatListValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class Vector2ListValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class Vector3ListValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class ListValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    public ISkillValue<object> Clone()
    {
      ...
      /*
      foreach (ISkillValue<object> v in m_List) {
        val.m_List.Add(v);
      }*/
      val.m_HaveValue = m_HaveValue;
      val.m_Value = m_Value;
    ...
    private List<ISkillValue<object>> m_List = new List<ISkillValue<object>>();
    private bool m_HaveValue;
    private List<object> m_Value;
  }
  internal sealed class RandomFromListValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private int m_ParamNum = 0;
    private ISkillValue<IList> m_ListValue = new SkillValue<IList>();
    private ISkillValue<object> m_DefaultValue = new SkillValue();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class ListGetValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private int m_ParamNum = 0;
    private ISkillValue<IList> m_ListValue = new SkillValue<IList>();
    private ISkillValue<int> m_IndexValue = new SkillValue<int>();
    private ISkillValue<object> m_DefaultValue = new SkillValue();
    private bool m_HaveValue;
    private object m_Value;
  }
  internal sealed class ListSizeValue : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
