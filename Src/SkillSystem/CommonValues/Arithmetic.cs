...
{
  internal sealed class AddOperator : ISkillValue<object>
  {
      ...
      if (m_X.HaveValue && m_Y.HaveValue) {
        ...
        if (objX is string || objY is string) {
          ...
          if (objX is int && objY is int) {
            int x = SkillValueHelper.CastTo<int>(objX);
            int y = SkillValueHelper.CastTo<int>(objY);
            m_Value = x + y;
          } else {
  ...
  internal sealed class SubOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class MulOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class DivOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class ModOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class AbsOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class FloorOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class CeilingOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class RoundOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class PowOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class LogOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class SqrtOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class SinOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class CosOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class SinhOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class CoshOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
  ...
  internal sealed class MinOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
    ...
    private void TryUpdateValue()
    {
      ...
      if (canCalc) {
        ...
        if (isInt) {
          ...
          for (int i = 0; i < m_List.Count; i++) {
            int v = SkillValueHelper.CastTo<int>(m_List[i].Value);
            if (minV > v)
              minV = v;
          }
          m_Value = minV;
          ...
          for (int i = 0; i < m_List.Count; i++) {
            float v = SkillValueHelper.CastTo<float>(m_List[i].Value);
            if (minV > v)
              minV = v;
          }
          m_Value = minV;
  ...
  internal sealed class MaxOperator : ISkillValue<object>
  {
    public void InitFromDsl(ScriptableData.ISyntaxComponent param)
    {
      ScriptableData.CallData callData = param as ScriptableData.CallData;
