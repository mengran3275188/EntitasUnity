...
namespace Skill
{
    ...
    public interface ISkillCommand
    {
        ...
        ISkillCommand Clone();
        void Reset();
        void Prepare(SkillInstance instance, object iterator, object[] args);
        ExecResult Execute(SkillInstance instance, long delta);
        void Analyze(SkillInstance instance);
    }
    public abstract class AbstractSkillCommand : ISkillCommand
    {
        ...
        public abstract ISkillCommand Clone();
        protected virtual void ResetState() { }
        protected virtual void UpdateArguments(object iterator, object[] args) { }
        protected virtual void UpdateVariables(SkillInstance instance) { }
        protected virtual ExecResult ExecCommand(SkillInstance instance, long delta)
        {
