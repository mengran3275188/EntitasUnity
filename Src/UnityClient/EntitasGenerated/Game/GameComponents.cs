...
public partial class GameEntity {
    ...
    public Entitas.Data.ParentComponent parent { get { return (Entitas.Data.ParentComponent)GetComponent(GameComponentsLookup.Parent); } }
    public bool hasParent { get { return HasComponent(GameComponentsLookup.Parent); } }

    public void AddParent(uint newValue) {
        var index = GameComponentsLookup.Parent;
        var component = CreateComponent<Entitas.Data.ParentComponent>(index);
        component.value = newValue;
        AddComponent(index, component);
    }

    public void ReplaceParent(uint newValue) {
        var index = GameComponentsLookup.Parent;
        var component = CreateComponent<Entitas.Data.ParentComponent>(index);
        component.value = newValue;
        ReplaceComponent(index, component);
