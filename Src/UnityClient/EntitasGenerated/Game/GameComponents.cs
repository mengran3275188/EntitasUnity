...
public partial class GameEntity {
    ...
    public void AddPhysics(Entitas.Data.RigidObject newRigid, Util.Vector3 newOffset) {
    ...
    public void ReplacePhysics(Entitas.Data.RigidObject newRigid, Util.Vector3 newOffset) {
        var index = GameComponentsLookup.Physics;
        var component = CreateComponent<Entitas.Data.PhysicsComponent>(index);
        component.Rigid = newRigid;
        component.Offset = newOffset;
...
public partial class GameEntity {
    ...
    public void AddCollision(Entitas.Data.RigidObject newRigid, Util.Vector3 newOffset, Entitas.Data.CollisionDelegate newOnCollision) {
    ...
    public void ReplaceCollision(Entitas.Data.RigidObject newRigid, Util.Vector3 newOffset, Entitas.Data.CollisionDelegate newOnCollision) {
        var index = GameComponentsLookup.Collision;
        var component = CreateComponent<Entitas.Data.CollisionComponent>(index);
        component.Rigid = newRigid;
        component.Offset = newOffset;
