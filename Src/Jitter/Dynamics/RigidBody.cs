...
namespace Jitter.Dynamics
{
    ...
    public class RigidBody : IBroadphaseEntity, IDebugDrawable, IEquatable<RigidBody>, IComparable<RigidBody>
    {
        ...
        internal Matrix3x3 inertia;
        internal Matrix3x3 invInertia;

        internal Matrix3x3 invInertiaWorld;
        internal Matrix3x3 orientation;
        internal Matrix3x3 invOrientation;
        ...
        public bool IsParticle { 
            ...
            set
            {
                ...
                else if (!isParticle && value)
                {
                    ...
                    this.invInertia = this.invInertiaWorld = Matrix3x3.Zero;
                    this.invOrientation = this.orientation = Matrix3x3.Identity;
                    inverseMass = 1.0f;
        ...
        /// </summary>
        public BBox BoundingBox { get { return boundingBox; } }
        ...
        public void SetMassProperties()
        {
            ...
            Matrix3x3.Inverse(ref inertia, out invInertia);
        ...
        public void SetMassProperties(Matrix3x3 inertia, float mass, bool setAsInverseValues)
        {
            if (setAsInverseValues)
            {
                if (!isParticle)
                {
                    ...
                    Matrix3x3.Inverse(ref inertia, out this.inertia);
                }
            ...
            else
            {
                if (!isParticle)
                {
                    ...
                    Matrix3x3.Inverse(ref inertia, out this.invInertia);
                }
        ...
        /// </summary>
        public Matrix3x3 Inertia { get { return inertia; } }

        /// <summary>
        /// The inverse inertia currently used for this body.
        /// </summary>
        public Matrix3x3 InverseInertia { get { return invInertia; } }
        ...
        /// </summary>
        public Matrix3x3 InverseInertiaWorld
        {
            get
            {
        ...
        public float Mass
        {
            ...
            set 
            {
                ...
                if (!isParticle)
                {
                    Matrix3x3.Multiply(ref Shape.inertia, value / Shape.mass, out inertia);
                    Matrix3x3.Inverse(ref inertia, out invInertia);
                }
        ...
        public virtual void Update()
        {
            ...
            else
            {
                ...
                Matrix3x3.Transpose(ref orientation, out invOrientation);
                ...
                if (!isStatic)
                {
                    Matrix3x3.Multiply(ref invOrientation, ref invInertia, out invInertiaWorld);
                    Matrix3x3.Multiply(ref invInertiaWorld, ref orientation, out invInertiaWorld);
                }
            }
        }
