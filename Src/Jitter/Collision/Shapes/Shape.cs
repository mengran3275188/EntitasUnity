...
namespace Jitter.Collision.Shapes
{
    ...
    public abstract class Shape : ISupportMappable
    {
        ...
        internal Matrix3x3 inertia = Matrix3x3.Identity;
        internal float mass = 1.0f;

        internal BBox boundingBox = BBox.LargeBox;
        ...
        /// </summary>
        public Matrix3x3 Inertia { get { return inertia; } protected set { inertia = value; } }
        ...
        public virtual void GetBoundingBox(ref Matrix3x3 orientation, out BBox box)
        {
        ...
        {
            GetBoundingBox(ref Matrix3x3.InternalIdentity, out boundingBox);
