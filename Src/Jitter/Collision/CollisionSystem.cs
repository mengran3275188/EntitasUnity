    ...
    public abstract class CollisionSystem
    {
        ...
        private void DetectSoftSoft(SoftBody body1, SoftBody body2)
        {
            ...
            for (int i = 0; i < other.Count; i++)
            {
                ...
                result = XenoCollide.Detect(myTriangle, otherTriangle, ref Matrix3x3.InternalIdentity, ref Matrix3x3.InternalIdentity,
        ...
        private void DetectRigidRigid(RigidBody body1, RigidBody body2)
        {
            ...
            else if (b1IsMulti && b2IsMulti)
            {
                ...
                BBox transformedBoundingBox = body2.boundingBox;
            ...
            else
            {
                ...
                BBox transformedBoundingBox = b2.boundingBox;
        ...
        private void DetectSoftRigid(RigidBody rigidBody, SoftBody softBody)
        {
            if (rigidBody.Shape is Multishape)
            {
                ...
                BBox transformedBoundingBox = softBody.BoundingBox;
                ...
                foreach (int i in detected)
                {
                    ...
                    for (int e = 0; e < msLength; e++)
                    {
                        ...
                        result = XenoCollide.Detect(ms, t, ref rigidBody.orientation, ref Matrix3x3.InternalIdentity,
            ...
            else
            {
                ...
                foreach (int i in detected)
                {
                    ...
                    result = XenoCollide.Detect(rigidBody.Shape, t, ref rigidBody.orientation, ref Matrix3x3.InternalIdentity,
                        ref rigidBody.position, ref Vector3.InternalZero, out point, out normal, out penetration);
