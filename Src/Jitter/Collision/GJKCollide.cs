...
namespace Jitter.Collision
{
    ...
    public sealed class GJKCollide
    {
        ...
        public static bool Pointcast(ISupportMappable support, ref Matrix3x3 orientation,ref Vector3 position,ref Vector3 point)
        {
            ...
            while ((dist > epsilon) && (maxIter-- != 0))
            {
                ...
                if (VdotW > 0.0f)
                {
                    ...
                    if (VdotR >= -(Mathf.Epsilon * Mathf.Epsilon)) { simplexSolverPool.GiveBack(simplexSolver); return false; }
        ...
        public static bool ClosestPoints(ISupportMappable support1, ISupportMappable support2, ref Matrix3x3 orientation1,
